...
public class Main {
    ...
    private static void getArraySumm(String[][] str) throws MyArraySizeException, MyArrayDataException {
        if (str.length != 4) {
    ...
    private static void inputDate(String str, int x, int y) throws MyArrayDataException {
        for (int i = 0; i < str.length(); i++) {
